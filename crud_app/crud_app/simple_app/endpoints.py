...
con_string = "mongodb+srv://siddu:123@cluster0.wj7rnds.mongodb.net/?retryWrites=true&w=majority"

client = pymongo.MongoClient(con_string)

db = client.get_database('sample')

user_collection = pymongo.collection.Collection(db, 'Test') #(<database_name>,"<collection_name>")
print("MongoDB connected Successfully")


def project_api_routes(endpoints):
    @endpoints.route('/helloworld', methods=['GET'])
    def hello():
        res = 'Hello world'
        print("Hello world")
        return res
